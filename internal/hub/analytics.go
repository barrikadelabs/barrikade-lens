...
var productEventProperties = map[string]map[string]bool{
	...
	"github_authorization_failed":        {"failure": true},
	"github_first_scan_started":          {},
	"github_first_scan_completed":        {"status": true, "partial": true, "duration_ms": true},
	"github_first_result_received":       {"duration_ms": true},
	...
	"quick_scan_started":                 {},
	"quick_scan_completed":               {"status": true, "partial": true, "duration_ms": true, "queue_ms": true, "system_count_bucket": true},
	"quick_scan_failed":                  {"failure": true, "duration_ms": true, "queue_ms": true},
	"quick_scan_converted":               {},
...
var safeStringValues = map[string]map[string]bool{
	...
	"failure":             {"validation": true, "normalization": true, "provider": true, "timeout": true, "internal": true, "discovery": true, "upload": true, "interrupted": true},
