...
export function getScanPaths(cwd = process.cwd()) {
  ...
  addPath(
    'Cline (Global)',
    path.join(home, '.cline', 'data', 'settings', clineFilename),
    'global',
    'mcpServers',
  );
  ...
  addPath(
    ...
    path.join(cwd, '.copilot', 'mcp-config.json'),
    'project',
    'mcpServers',
  );
  addPath(
  ...
  addPath(
    'Amazon Q (Global Default)',
    path.join(home, '.aws', 'amazonq', 'default.json'),
    'global',
    'amazonq',
  );
  addPath(
    'Amazon Q (Project MCP)',
    path.join(cwd, '.amazonq', 'mcp.json'),
    'project',
    'mcpServers',
  );
  addPath(
    'Amazon Q (Project Default)',
    path.join(cwd, '.amazonq', 'default.json'),
    'project',
    'amazonq',
  );
  ...
  addPath(
    'JetBrains Junie (Project)',
    path.join(cwd, '.junie', 'mcp', 'mcp.json'),
    'project',
    'mcpServers',
  );
  ...
  if (platform === 'darwin') {
    ...
    addPath(
      'VS Code (Global Insiders Native MCP)',
      path.join(
        home,
        'Library',
        'Application Support',
  ...
  addPath(
    'Continue (Global JSON)',
    path.join(home, '.continue', 'config.json'),
    'global',
    'continue',
  );
  addPath(
    'Continue (Project JSON)',
  ...
  addPath(
    'Continue (Project YAML)',
    path.join(cwd, '.continue', 'config.yaml'),
    'project',
    'yaml',
  );
  ...
  addPath(
    'Antigravity CLI Config (User)',
    path.join(home, '.gemini', 'config.json'),
    'global',
    'antigravityCli',
  );
  addPath(
    'Antigravity CLI Settings (User)',
    path.join(home, '.gemini', 'settings.json'),
    'global',
    'antigravityCli',
  );
  addPath(
    'Antigravity SDK Config (User)',
    path.join(home, '.gemini', 'antigravity', 'config.json'),
    'global',
    'antigravity',
  );
  addPath(
    'Antigravity SDK Settings (User)',
    path.join(home, '.gemini', 'antigravity', 'settings.json'),
    'global',
    'antigravity',
  );
  addPath(
    'Antigravity CLI Config (Project)',
    path.join(cwd, '.gemini', 'config.json'),
    'project',
    'antigravityCli',
  );
  addPath(
    'Antigravity CLI Settings (Project)',
    path.join(cwd, '.gemini', 'settings.json'),
    'project',
    'antigravityCli',
  );
  addPath(
    'Antigravity SDK Config (Project)',
    path.join(cwd, '.gemini', 'antigravity', 'config.json'),
    'project',
    'antigravity',
  );
  addPath(
    'Antigravity SDK Settings (Project)',
    path.join(cwd, '.gemini', 'antigravity', 'settings.json'),
    'project',
    'antigravity',
  );
  ...
  addPath(
    'OpenCode Root (Project JSON)',
    path.join(cwd, 'opencode.json'),
    'project',
    'opencode',
  );
  addPath(
    'OpenCode Root (Project JSONC)',
  ...
  addPath(
    'Codex CLI Global State (User)',
    path.join(home, '.codex', '.codex-global-state.json'),
    'global',
    'codex',
  );
  addPath(
    'Codex CLI (Project TOML)',
...
export function getAgentStateDirs(cwd = process.cwd()) {
  ...
  const dirs = [
    ...
    },
    {
      ...
      path: path.join(cwd, '.opencode'),
      scope: 'project',
    },
    {
      name: 'Kiro IDE Project',
      path: path.join(cwd, '.kiro'),
      scope: 'project',
    },
    {
      name: 'Amazon Q Project',
      path: path.join(cwd, '.amazonq'),
      scope: 'project',
    },
    {
      name: 'GitHub Copilot CLI Project',
      path: path.join(cwd, '.copilot'),
      scope: 'project',
    },
    {
      name: 'JetBrains Junie Project',
      path: path.join(cwd, '.junie'),
      scope: 'project',
    },
    {
      name: 'GitHub Config Folder',
      path: path.join(cwd, '.github'),
      scope: 'project',
    },
    {
      name: 'Zed Project Config',
      path: path.join(cwd, '.zed'),
      scope: 'project',
    },
    {
      name: 'Codex Project Config',
      path: path.join(cwd, '.codex'),
      scope: 'project',
    },
    {
      name: 'Antigravity CLI/SDK Project Config',
      path: path.join(cwd, '.gemini'),
      scope: 'project',
    },
    {
      name: 'VS Code Project Config',
      path: path.join(cwd, '.vscode'),
      scope: 'project',
    },
  ];
...
export function getModelDirs() {
  ...
  if (platform === 'darwin') {
    dirs.push({
      ...
      path: path.join(home, 'Library', 'Application Support', 'LM Studio'),
    });
  } else if (platform === 'win32') {
    dirs.push({
      name: 'LM Studio Cache',
    ...
    dirs.push({
      name: 'LM Studio Cache',
      path: path.join(home, '.config', 'LM Studio'),
    });
  }
