...
export function ChangesPage({ api, revision }: { api: API; revision: number }) {
  ...
  return <div className="page-stack"><FilterBar hideSearch>
    ...
    <Select label="Category" value={filters.category} onChange={(value) => update("category", value)} options={{ "": "All important changes", state: "Status", network_scope: "Network access", attribution: "Owner", capability: "Connections", confidence: "Confidence", identity: "Identity", freshness: "Last report" }} />
